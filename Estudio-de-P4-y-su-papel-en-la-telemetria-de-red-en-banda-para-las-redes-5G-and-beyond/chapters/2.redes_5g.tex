...
\begin{itemize}
    ...
    \item \textbf{N2}: Conecta la estación base 5G (gNodeB) con el AMF en el plano de control. Utiliza el protocolo NGAP (Next Generation Application Protocol) \cite{3gpp.ts.38.401} para la señalización y gestión de la conexión entre el gNodeB y el AMF.
