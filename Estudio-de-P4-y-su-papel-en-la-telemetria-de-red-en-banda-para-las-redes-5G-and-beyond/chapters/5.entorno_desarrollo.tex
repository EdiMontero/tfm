...
En la figura \ref{fig:grafana-configuration} se muestra la pantalla de configuración de la fuente de datos en Grafana.
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{images/configuracion-grafana.png}
